...
public class WinMenu extends BaseScreen {
    ...
    public void otherName() {
        int randomFirst = MathUtils.random(0, firstNames.length - 1);
        int randomLast = MathUtils.random(0, lastNames.length - 1);
        this.currentName = firstNames[randomFirst] + " " + lastNames[randomLast];
    }
